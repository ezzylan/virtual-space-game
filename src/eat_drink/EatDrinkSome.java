...
public class EatDrinkSome implements EatDrinkBehaviour {
    ...
    public void eatDrink(int pasta, int juice, int cake, ImageView foodBG1, ImageView foodBG2, ImageView foodBG3) throws LineUnavailableException, IOException, UnsupportedAudioFileException {
        if (cake != 0){
            ...
            Image image1 = new Image(getClass().getResourceAsStream("../resources/img/cake-unfinished.png"));
        ...
        if (juice != 0){
            ...
            Image image2 = new Image(getClass().getResourceAsStream("../resources/img/juice-unfinished.png"));
        ...
        if (pasta != 0){
            ...
            Image image3 = new Image(getClass().getResourceAsStream("../resources/img/pasta-unfinished.png"));
